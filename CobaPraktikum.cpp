...
int main() {
    // Buat admin
    Admin admin("Febian", "febian@example.com");
 
    // Buat beberapa member
    Member* m1 = new Member("Kipli",  "kipli@mail.com");
    Member* m2 = new Member("Cinta",  "cinta@mail.com");
    Member* m3 = new Member("Manda",  "manda@mail.com");
